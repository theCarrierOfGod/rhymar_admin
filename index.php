                ...
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <div class="icon icon-shape icon-md icon-shape-blue rounded mr-4 mr-sm-0"><span class="fa fa-layer-group"></span></div>
                            <div class="d-sm-none">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            ...
                            <div class="text-right">
                                <a href="new-product.php" class="btn btn-outline-dark btn-sm mr-3 text-right">
                                    Add New
                                </a>
                            </div>
                        </div>
        ...
        <div class="col-12 col-sm-6 col-xl-4 mb-4">
            <div class="card border-light shadow-sm">
                <div class="card-body">
                    <div class="row d-block d-xl-flex align-items-center">
                        <div class="col-12 col-xl-5 text-xl-center mb-3 mb-xl-0 d-flex align-items-center justify-content-xl-center">
                            <div class="icon icon-shape icon-md icon-shape-blue rounded mr-4 mr-sm-0"><span class="fa fa-list-alt"></span></div>
                            <div class="d-sm-none">
                        ...
                        <div class="col-12 col-xl-7 px-xl-0">
                            ...
                            <div class="text-right">
                                <a href="new-category.php" class="btn btn-outline-dark btn-sm mr-3 text-right">
                                    Add New
                                </a>
                            </div>
                        </div>
