                                ...
                                <div class="col-12 col-sm-6 col-md-4">
                                    <div class="card border-light shadow-sm m-1">
                                        ...
                                        <div class="card-header" style="text-transform: uppercase; font-family: monospace">
                                            ...
                                            <a href="/edit_category.php?id=<?php echo $pro['id']; ?>" style="color: blue">
                                                <i class="fa fa-pencil"></i> Edit
                                            </a>
                                            <a id="<?php echo $pro['id']; ?>" style="color: red;">
                                                <i class="fa fa-trash"></i> Delete
                                            </a>
                                            <script>
                                                $(document).ready(function(){
                                                    $("#<?php echo $pro['id']; ?>").on("click", function() {
                                                        let text;
                                                        if (confirm("Are you sure you want to delete this category?") == true) {
                                                            window.location.href = "/delete_category.php?id=<?php echo $pro['id']; ?>";
                                                        }
                                                    });
                                                });
                                            </script>
